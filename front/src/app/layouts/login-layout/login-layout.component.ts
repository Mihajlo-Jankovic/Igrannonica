...
export class LoginLayoutComponent implements OnInit {
  ...
  constructor(public lang:LanguageService,private notify: NotificationsService, private toastr: ToastrService, private formBuilder: FormBuilder,  private loginService: LoginService, private editPasswordService: EditPasswordService, private cookie: CookieService, private router: Router, private http: HttpClient) {
