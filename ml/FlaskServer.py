...
def startTraining():
    ...
    if (content_type == 'application/json; charset=utf-8'):
        ...
        thread = threading.Thread(target=program.startTraining, args=[json['connID'],json['fileName'], json['inputList'], json['output'], json['encodingList'], json['ratio'], json['numLayers'], json['layerList'], json['activationFunction'], json['regularization'], json['regularizationRate'], json['optimizer'], json['learningRate'], json['problemType'], json['lossFunction'], json['metrics'], json['numEpochs']])
        thread.start()
